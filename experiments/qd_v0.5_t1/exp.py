...
dest = "/media/ruben/data/documents/unief/thesis/thesis_manta_ray/experiments/qd_v0.5_t1/evolution_simulation_correct_version.py"
...
if __name__ == "__main__":
    ...
    map_elites = MapElites(archive, archive_file="experiments/qd_v0.5_t1/sim_objects/archive.pkl")
    ...
    map_elites.optimization_info(store="experiments/qd_v0.5_t1/plots/opt_info.html")
    archive.plot_grid_3d(x_label="roll", y_label="pitch", z_label="yawn", store="experiments/qd_v0.5_t1/plots/grid.html")
    sim.finish(store=True, name="qd_v0.5_t1/sim_objects/sim")