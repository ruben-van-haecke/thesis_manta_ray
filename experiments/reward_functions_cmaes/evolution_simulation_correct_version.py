...
class OptimizerSimulation:
    ...
    def evaluate_qd(self, individual):
    ...
    def run(self):
        if isinstance(self._outer_optimalization, QDWrapper):
            self._outer_optimalization._alg.optimise(evaluate=self.evaluate_qd)
...
if __name__ == "__main__":
    ...
    qd_obj = QDWrapper(algorithm=algorithms.RandomSearchMutPolyBounded, container=grid, budget=2e10, batch_size=10,
            dimension=4, optimisation_task="minimization")
