...
# Load the .pkl file
this_dir = "/media/ruben/data/documents/unief/thesis/thesis_manta_ray/experiments/energy_velocity_experiment/"
...
def get_sim(velocity: float, 
    ...
    while not success:
        try:
            ...
            sim = OptimizerSimulation.load("energy_velocity_experiment/sim_objects/energy_velocity_"+velocity_str+"_reward_function_"+reward_str)
            success = True
            ...
            print("file: ", "energy_velocity_experiment/sim_objects/energy_velocity_"+velocity_str+"_reward_function_"+reward_str)
    return sim
